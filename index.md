...
My real goal isn't to teach you R, but to teach you the basic concepts that all programming depends on.

:::::::::::::::::::::::::::::::::::::::::: prereq

Learners need to understand the concepts of files and directories (including the working directory).
I will use RStudio to teach this lesson, but it is not required (I put this lesson together using Neovim).
